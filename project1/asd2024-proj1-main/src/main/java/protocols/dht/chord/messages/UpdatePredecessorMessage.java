...
public class UpdatePredecessorMessage extends ProtoMessage {
	...
	public UpdatePredecessorMessage(UUID mid, short toDeliver, Host sender, BigInteger senderPeerID) {
		super(MSG_ID);
		this.mid = mid;
	...
	public UpdatePredecessorMessage(UUID mid, short toDeliver, ChordNode thisNode) {
		super(MSG_ID);
		this.mid = mid;
		this.toDeliver = toDeliver;
	...
	public static ISerializer<UpdatePredecessorMessage> serializer = new ISerializer<>() {
		@Override
		public void serialize(UpdatePredecessorMessage findSuccessorMessage, ByteBuf out) throws IOException {
		...
		@Override
		public UpdatePredecessorMessage deserialize(ByteBuf in) throws IOException {
			...
			return new UpdatePredecessorMessage(mid, toDeliver, sender, new BigInteger(senderPeerIDByteArray));
		}
	};
}
